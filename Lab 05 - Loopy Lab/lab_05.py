...
def draw_section_5():
    ...
    for row in range(30):
        for column in range(row + 1):
            x = (30 - column) * 10 - 5  # Instead of zero, calculate the proper x location using 'column'
...
def draw_section_8():
    for row in range(30):
        for column in range(row + 1):
            x = (29 - column) * 10 + 905  # Instead of zero, calculate the proper x location using 'column'
            y = row * 10 + 305  # Instead of zero, calculate the proper y location using 'row'
            arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
