...
arcade.draw_triangle_filled(400, 400, 370, 320, 430, 320, arcade.csscolor.DARK_GREEN) #(x, y, x, y, x, y)
...
arcade.draw_polygon_filled(((500, 400),
                           ...
                           arcade.csscolor.DARK_GREEN)  # (((x, y), (x, y) etc...

# Draw a sun
arcade.draw_circle_filled(500, 550, 40, arcade.color.YELLOW)

# Rays to the left, right, up, and down
arcade.draw_line(500, 550, 400, 550, arcade.color.YELLOW, 3)  # start of line x, y, end of line x,y, color, thickness of line
...
arcade.draw_text("Arbor Day - Plant a Tree!",
                 150, 230,
                 arcade.color.BLACK, 24) # default to drawing at lower left corner of specified point.

"""
Also can be done like this to be able to better see parameters:
